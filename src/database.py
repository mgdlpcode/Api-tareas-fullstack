...
if not DATABASE_URL:
    raise ValueError("DATABASE_URL no está definida. Configura la variable de entorno o un archivo .env")
...
# ---------- Repositorio ----------
def db_crear_tarea(db: Session, persona: str, descripcion: str) -> Tarea:
    tarea = Tarea(
        persona=persona,
